...
- components.js := The _components.js_ file is a temporary file created by the Golf server. It contains, more or less, a compiled version of the app. There's nothing configurable inside, so disregard.
