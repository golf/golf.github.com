...
* *plugins* This is where the jQuery plugins and component mixins are located. For example, if there is a script _&lt;approot&gt;/plugins/script.js_, you would load it form your JS code as @$.require("script")@ or @var script = $.require("script")@, etc. (See "plugins":/plugins-extending-jquery-in-golf/ and "mixins":/mixins-extending-the-component-api/.)
