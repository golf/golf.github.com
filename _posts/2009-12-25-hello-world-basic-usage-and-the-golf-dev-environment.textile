...
$.golf.controller = [
  { route: ".*",
    action: function(container, params) {
      container.empty().append("<h1>Hello, world! This is "+params[0]+"!</h1>");
    }
  }
];
{% endhighlight %}
...
Notice how the application remains accessible, regardless of whether JS is enabled, or not. The JS proxy mechanism that makes this possible is discussed in depth in the _Technical_ section of the docs.
