...
Next, we will create the _components/HelloWorld_ directory. This is the folder that will contain all of the component resources.

bc. mkdir components/HelloWorld

Inside of the _components_ directory you can make subdirectories in a way similar to Java's package system. Placing a component in the _components/com/example_ directory will cause the component to be in the _com.example_ namespace. But for now we'll keep things simple and not worry about namespaces yet.
