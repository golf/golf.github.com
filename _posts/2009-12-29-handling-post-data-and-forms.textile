...
We will make a component in which we will create the form. Let's call the component _FormExample_. The _FormExample.html_ file should contain the following:
