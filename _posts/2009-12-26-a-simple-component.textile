...
The component's structure and behavior is defined in an HTML file, _HelloWorld.html_. This is where the HTML, CSS, and JavaScript will be. Create the file _components/com/example/HelloWorld.html_, with the following contents:
