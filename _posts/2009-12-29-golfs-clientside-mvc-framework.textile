...
The actual controller code is deep within the Golf runtime. When you develop apps you configure it by adding =={== _route_, _action_ ==}== tuples to a special controller array, @$.golf.controller@, in the _controller.js_ file.
