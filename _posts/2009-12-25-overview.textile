...
* *Component templates using jQuery:* JQuery is, arguably, the ultimate HTML templating engine. Golf components are built from HTML templates, and the component constructor and public methods use jQuery to insert content dynamically. Very smooth and simple.
