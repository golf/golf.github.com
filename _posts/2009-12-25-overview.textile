...
With Javascript Proxying your app is a full clientside affair. No sessions to recreate the app's state for each request. No serverside form handling. No agonizing over graceful degradation.
