...
* *Plugins, Mixins, And Libraries:* Golf apps can load global jQuery plugins and library scripts, as expected. But Golf also provides a flexible, yet powerful subset of ServerJS functionality that allows the use of component mixins and local namespace loading of libraries.
